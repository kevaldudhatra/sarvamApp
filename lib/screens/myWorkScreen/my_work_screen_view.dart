...
class MyWorkScreenView extends StatefulWidget {
  const MyWorkScreenView({Key? key}) : super(key: key);

  @override
  State<MyWorkScreenView> createState() => _MyWorkScreenViewState();
}

class _MyWorkScreenViewState extends State<MyWorkScreenView> {
  @override
