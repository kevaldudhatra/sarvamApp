...
class FeedbackScreenView extends StatefulWidget {
  const FeedbackScreenView({Key? key}) : super(key: key);
                              ...
                              child: CustomButton(
                                ...
                                onTap: () async {
                                  if (subject.text.toString().isEmpty) {
                                    Get.snackbar("Oops!", "Subject required!", icon: const Icon(Icons.error, color: Colors.red), colorText: Colors.black, snackPosition: SnackPosition.TOP, backgroundColor: backgroundWhite);
